...
import 'package:flutterbloctutorial/features/home/models/home_product_data_model.dart';
      ...
      child: Column(
        ...
        children: [Container(
          ...
          Row(
            ...
            children: [Text("\$"+productDataModel.price.toString(), style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            Row(
              children: [
